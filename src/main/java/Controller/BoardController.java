            ...
            if(felter[i].getNr()==2||felter[i].getNr()==8||felter[i].getNr()==18||felter[i].getNr()==23||felter[i].getNr()==34||felter[i].getNr()==37){
               ...
               // field.setBackGroundColor(felter[i].getColor());
                ...
                gui_fields[i] = field;
                    ...
                    System.out.println(felter[i].getColor());
...
/* if(felter[i].getNr()!=1&&felter[i].getNr()!=3&&felter[i].getNr()!=5&&felter[i].getNr()!=6&&felter[i].getNr()!=8&&felter[i].getNr()!=11
            &&felter[i].getNr()!=13&&felter[i].getNr()!=16&&felter[i].getNr()!=18&&felter[i].getNr()!=21
            &&felter[i].getNr()!=23&&felter[i].getNr()!=26&&felter[i].getNr()!=29&&felter[i].getNr()!=31&&felter[i].getNr()!=34&&felter[i].getNr()!=36&&felter[i].getNr()!=37&&felter[i].getNr()!=39){
        System.out.println(felter[i].getColor());
        GUI_Field field = new GUI_Street();
        field.setTitle(felter[i].getName());
        field.setBackGroundColor(felter[i].getColor());
